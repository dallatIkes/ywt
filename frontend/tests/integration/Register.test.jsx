...
describe('Register page', () => {
    ...
    it('shows error when passwords do not match', async () => {
        ...
        await userEvent.type(screen.getByPlaceholderText('3–20 characters'), 'newuser')
        await userEvent.type(screen.getByPlaceholderText('min 8 characters'), 'password123')
        await userEvent.type(screen.getByPlaceholderText('••••••••'), 'different123')
    ...
    it('shows backend error on failed register', async () => {
        ...
        await userEvent.type(screen.getByPlaceholderText('3–20 characters'), 'takenuser')
        await userEvent.type(screen.getByPlaceholderText('min 8 characters'), 'password123')
        await userEvent.type(screen.getByPlaceholderText('••••••••'), 'password123')
        await userEvent.click(screen.getByRole('button', { name: /create account/i }))
